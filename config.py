...
API_KEY = "sk-api-xyhelper-cn-free-token-for-everyone-xyhelper"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://api.xyhelper.cn/v1/chat/completions"}
